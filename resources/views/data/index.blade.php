            ...
            <div class="col-md-12 mt-5">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        ...
                        <a href="{{ url('downloads') }}" target="_blank" class="btn btn-success float-right"><i
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-striped table-bordered nowrap" width="100%">
                                <thead>
                                    ...
                                    <th style="text-align: center">Kelembapan Udara</th>
                                    <th style="text-align: center">Kelembapan Tanah</th>
                                </thead>
                                <tbody>
                                    @foreach ($list_monitoring as $data)
                                        <tr>
                                            ...
                                            <td style="text-align: center">{{ $data->kelembapan_udara }} %</td>
                                            <td style="text-align: center">{{ $data->kelembapan_tanah }} %</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
